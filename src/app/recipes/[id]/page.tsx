    ...
    <PageTransition>
      <div className="mx-auto flex min-h-dvh w-full max-w-md flex-col gap-3 px-4 pt-2 pb-10">
        <header className="flex h-13 items-center justify-between">
          <Link href="/recipes" transitionTypes={['nav-back']} aria-label="Về sổ công thức" className="flex size-11 items-center justify-center">
        ...
        {steps.length > 0 ? (
          <Link
            href={`/recipes/${recipe.id}/cook`} transitionTypes={['nav-forward']}
